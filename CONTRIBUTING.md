...
Welcome to the contributor guide of CronSpell.
...
If you experience bugs or general issues with CronSpell, please have a look
...
You can help improve the documentation of CronSpell by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/cronspell.git
   cd cronspell
   ```
